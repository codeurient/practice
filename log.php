...
<div class="center">
    ...
    <form action="log.php" method="post">
        ...
        <input class="always-white" name="password" type="password" placeholder="Password">
        ...
        <div class="auth">
            <button name="button-log" type="submit">Log in</button>
            <a href="<?php echo BASE_URL . "reg.php" ?>">Sign up for practice</a>
        </div>
    </form>
</div>
